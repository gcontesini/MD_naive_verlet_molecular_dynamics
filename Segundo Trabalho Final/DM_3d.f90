...
real*8							 :: compressibilidade_adiabatica_float
...
! Calculo da Compressibilidade Adiabatica ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

compressibilidade_adiabatica_float = ( 																				&
7*prmed-((16*den*2.d0*Ecmed/dfloat(3*nat))/3)																	&
-8*den*(Emmed/dfloat(nat)+Epmed/dfloat(nat)+Ecmed/dfloat(nat))-								&
( nat /(den*2.d0*Ecmed/dfloat(3*nat)) ) )**(-1)
...
write(*,'(a,f12.4)')   ' Compressibilidade adiabatica          =', compressibilidade_adiabatica_float
print*
!pause
